...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  private readonly allPages = [
    ...
    { name: 'Mobility Hub', path: '/mobility-dashboard', icon: 'car' },
    { name: 'Rides', path: '/ride-booking', icon: 'steering-wheel' },
    { name: 'Car Rentals', path: '/car-rental', icon: 'key' },
    { name: 'Logistics', path: '/parcel-logistics', icon: 'truck' },
    { name: 'Fleet', path: '/fleet-management', icon: 'radar' },
    { name: 'Transit', path: '/corporate-transport', icon: 'building' },
    { name: 'Live Tracking', path: '/live-tracking', icon: 'map-pin' },
    { name: 'Driver Verification', path: '/vehicle-driver-verification', icon: 'user-check' },
    ...
    { name: 'Calendar', path: '/calendar', icon: 'calendar-event' },
    { name: 'Documents', path: '/employee-documents', icon: 'file-check' },
    { name: 'Workforce', path: '/workforce', icon: 'settings' },
    ...
    { name: 'Invoices', path: '/invoices', icon: 'file-text' },
    { name: 'POS Terminal', path: '/pos-billing', icon: 'receipt-2' },
    { name: 'Devices', path: '/devices', icon: 'devices' },
    { name: 'Billing', path: '/billing-history', icon: 'receipt' },
    { name: 'Profit & Loss', path: '/profit-loss', icon: 'chart-pie' },
    { name: 'Branches', path: '/branch', icon: 'building' },
    { name: 'Categories', path: '/category', icon: 'folder' },
    { name: 'Coupons', path: '/coupons', icon: 'ticket' },
    { name: 'Payments', path: '/payments', icon: 'credit-card' },
    { name: 'Deliveries', path: '/delivery-tracking', icon: 'truck' },
    { name: 'Alerts', path: '/alerts', icon: 'alert-circle' },
    { name: 'Menu Management', path: '/menubar', icon: 'layout-navbar' },
    { name: 'Statuses', path: '/status', icon: 'list-check' },
    { name: 'Chat', path: '/communication', icon: 'messages' },
    { name: 'Meetings', path: '/communication/meetings', icon: 'video' },
  ];
