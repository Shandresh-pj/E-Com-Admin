...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  private readonly allPages = [
    ...
    { name: 'Ride & Taxi (Uber/Rapido)', path: '/ride-booking', icon: 'steering-wheel' },
    { name: 'Car Rental Hub (Zoomcar)', path: '/car-rental', icon: 'key' },
    { name: 'Parcel & Freight (Porter)', path: '/parcel-logistics', icon: 'truck' },
    { name: 'Fleet Asset Control', path: '/fleet-management', icon: 'radar' },
    { name: 'Corporate & School Transit', path: '/corporate-transport', icon: 'building' },
    { name: 'Live GPS Telemetry', path: '/live-tracking', icon: 'map-pin' },
    { name: 'Vehicle & Driver Verification KYC', path: '/vehicle-driver-verification', icon: 'user-check' },
