...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  private readonly allPages = [
    ...
    { name: 'Mobility Hub', path: '/dashboard/mobility-dashboard', icon: 'car' },
    { name: 'Ride & Taxi (Uber/Rapido)', path: '/dashboard/ride-booking', icon: 'steering-wheel' },
    { name: 'Car Rental Hub (Zoomcar)', path: '/dashboard/car-rental', icon: 'key' },
    { name: 'Parcel & Freight (Porter)', path: '/dashboard/parcel-logistics', icon: 'truck' },
    { name: 'Fleet Asset Control', path: '/dashboard/fleet-management', icon: 'radar' },
    { name: 'Corporate & School Transit', path: '/dashboard/corporate-transport', icon: 'building' },
    { name: 'Live GPS Telemetry', path: '/dashboard/live-tracking', icon: 'map-pin' },
    { name: 'Vehicle & Driver Verification KYC', path: '/dashboard/vehicle-driver-verification', icon: 'user-check' },
